...
## Artifact for v0.1.0-beta.2

| Platform | Artifact | Purpose |
| --- | --- | --- |
| macOS Apple Silicon | `VidStow-0.1.0-beta.2-darwin-arm64.zip` | Checksum-pinned payload consumed by the Homebrew cask |

The published [`v0.1.0-beta.2`](https://github.com/vidstow/vidstow/releases/tag/v0.1.0-beta.2)
...
./scripts/package-release-archives.sh \
  0.1.0-beta.2 darwin arm64 build/bin/VidStow.app
```
